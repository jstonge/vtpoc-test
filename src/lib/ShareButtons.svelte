<script lang="ts">
  ...
  let { title = 'BIPOC Growth in Vermont: A Data Story', text = 'Check out this data story about BIPOC growth in Vermont' }: Props = $props();
  ...
  function shareViaEmail() {
    ...
    const body = encodeURIComponent(`Check out this important data story: ${window.location.href}`);
...
<style>
  ...
  .share-button.copy { background: var(--color-navy, #25466A); }
